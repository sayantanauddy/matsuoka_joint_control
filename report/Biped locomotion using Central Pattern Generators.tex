...
\begin{figure}[htbp]
\centering     %%% not \center
\subfigure[Anti-phase oscillations]{\label{fig:b}\includegraphics[scale=0.33]{figures/4-1-anti-phase.eps}}
\subfigure[In-phase oscillations]{\label{fig:a}\includegraphics[scale=0.33]{figures/4-2-in-phase.eps}}
