...
\newcommand{\trtitle}{Bio-inspired Bipedal Locomotion using Central Pattern Generators}
\newcommand{\trmatrikelnummer}{6640595}
\newcommand{\tremail}{4auddy@informatik.uni-hamburg.de}
\newcommand{\trarbeitsbereich}{Knowledge Technology, WTM}
\newcommand{\trdate}{27.12.2016}
...
\begin{figure}[H]
\centering     %%% not \center
\subfigure[Snapshots from video\# 7 in \cite{Vid_Nao_Matsuoka}, joints moving with different frequencies]{\label{fig:nao_motion}\includegraphics[scale=0.12]{figures/nao_joint_motion.png}}
\subfigure[Two joints moving in-phase but with different frequencies. Coupling is switched on at t=10s]{\label{fig:nao_graph}\includegraphics[scale=0.24]{figures/double-joint-in-phase-diff-freq.eps}}
