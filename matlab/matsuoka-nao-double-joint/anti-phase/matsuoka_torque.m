...
%   using the equations for the matsuoka osccillator
    ...
    dpsi_r_j = (-psi_r_j -(beta*phi_r_j) -eta*max([0,psi_r_i])  -sigma*max([0, (matlabSensedAngle_r - theta_star)])  - mu*max([0, (matlabSensedAngle_l - theta_star)]) - nu*max([0, -(matlabSensedAngle_l - theta_star)]) + u_j)*1/t1;
